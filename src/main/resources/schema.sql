...
CREATE TABLE Giant_Garage (id INT NOT NULL Primary Key AUTO_INCREMENT, make VARCHAR(100), model VARCHAR(100), colour VARCHAR(100), price DECIMAL(12,2), vin VARCHAR(100));

INSERT INTO Giant_Garage (make, model, colour, price, vin) VALUES 
...
CREATE TABLE Super_Garage (id INT NOT NULL Primary Key AUTO_INCREMENT, make VARCHAR(100), model VARCHAR(100), colour VARCHAR(100), price DECIMAL(12,2), vin VARCHAR(100));

INSERT INTO Super_Garage (make, model, colour, price, vin) VALUES 
